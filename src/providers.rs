        ...
        self.register(Provider {
            ...
            models: vec![
                ModelInfo {
                    ...
                    supports_json_mode: false,
                    supports_vision: false,
                    description: "DeepSeek V4 Pro via ZSCC (不支持JSON mode)".to_string(),
                },
                ModelInfo {
                    ...
                    supports_json_mode: false,
                    supports_vision: false,
                    description: "DeepSeek V4 Flash via ZSCC (不支持JSON mode)".to_string(),
                },
                ModelInfo {
                ...
                ModelInfo {
                    id: "minimax-m2.5-cc".to_string(),
                    name: "MiniMax M2.5".to_string(),
                    context_length: 128_000,
                    max_output_tokens: 8192,
                    supports_json_mode: true,
                    supports_vision: false,
                    description: "MiniMax M2.5 via ZSCC".to_string(),
                },
            ],
        });
